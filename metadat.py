...
if __name__ == "__main__":
    image_file_name = input("Enter the name of the image file: ")

    if not os.path.exists(image_file_name):
        print("Image file not found.")
    else:
        metadata = extract_image_metadata(image_file_name)
        ...
        save_metadata_to_file(metadata, image_file_name)
        print(f"\nMetadata saved to {metadata['File Name'].replace('.', '_')}.txt")